...
export default function CampusAmbassadorPage() {
  useEffect(() => {
    ...
    "Be the face of IRL on your campus — host, network, and get people talking.",
    "You know the social scene better than anyone and know how to move a crowd.",
  ];
  ...
  return (
    <main className="min-h-screen bg-background selection:bg-accent-pink/30 selection:text-white overflow-x-hidden flex flex-col">
      ...
      <section className="flex-1 pt-32 pb-24 px-6 relative z-10 flex flex-col items-center">
        ...
        <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-[radial-gradient(circle_at_50%_50%,rgba(242,167,192,0.1),transparent_60%)] pointer-events-none -z-10 blur-3xl" />
          ...
          <FadeInUp duration={0.6} className="mb-8">
            ...
            <div className="flex flex-wrap gap-3 mb-6">
              <span className="bg-white/5 border border-white/10 px-4 py-1.5 rounded-full text-sm font-medium text-white/80 flex items-center gap-2">
                <Briefcase className="w-4 h-4 text-accent-pink" /> Community
              </span>
              <span className="bg-white/5 border border-white/10 px-4 py-1.5 rounded-full text-sm font-medium text-white/80 flex items-center gap-2">
                <MapPin className="w-4 h-4 text-accent-purple-light" /> Multiple Universities
              </span>
              <span className="bg-white/5 border border-white/10 px-4 py-1.5 rounded-full text-sm font-medium text-white/80 flex items-center gap-2">
                <Clock className="w-4 h-4 text-white" /> Part-Time
              </span>
            </div>
            ...
            <div className="mt-20 pt-16 border-t border-white/10 w-full flex flex-col items-center">
              ...
              <div className="mt-8 bg-white/[0.02] border border-white/10 rounded-[2.5rem] p-4 md:p-8 backdrop-blur-xl shadow-2xl relative w-full max-w-4xl min-h-[600px] flex flex-col items-center">
                ...
                <div className="relative z-10 w-full h-full min-h-[600px]">
                  <iframe 
                    data-tally-src="https://tally.so/embed/q4PxGO?alignLeft=1&hideTitle=1&transparentBackground=1&dynamicHeight=1&role=campus-ambassador" 
                    loading="lazy" 
                    width="100%" 
                    height="600" 
                    frameBorder="0" 
                    marginHeight={0} 
                    marginWidth={0} 
                    title="Apply for Campus Ambassador">
                  </iframe>
                </div>
              </div>
            </div>
